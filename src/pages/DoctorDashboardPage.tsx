            ...
            <>
              ...
              <Grid container spacing={2} gap={10} justifyContent="center">
                <Grid item xs={12} md={4}>
                  <Card sx={{ minWidth: 250 }}>
                    <CardActionArea onClick={() => handleOpen("symptoms")}>
                      <CardContent>
                        <Typography
                          variant="h6"
                ...
                <Grid item xs={12} md={4}>
                  <Card sx={{ minWidth: 250 }}>
                    <CardActionArea onClick={() => handleOpen("medications")}>
                      <CardContent>
                        <Typography
                          variant="h6"
                          sx={{ width: 650, height: 270 }}
                ...
                <Grid item xs={12} md={4}>
                  <Card sx={{ minWidth: 250 }}>
                    <CardActionArea onClick={() => handleOpen("clinicVisits")}>
                      <CardContent>
                        <Typography
                          variant="h6"
                          sx={{ width: 650, height: 270 }}
                ...
                <Grid item xs={12} md={4}>
                  <Card sx={{ minWidth: 250 }}>
                    <CardActionArea onClick={() => handleOpen("healthRecords")}>
                      <CardContent>
                        <Typography
                          variant="h6"
                          sx={{ width: 650, height: 270 }}
              ...
              <Dialog open={open} onClose={handleClose} maxWidth="md" fullWidth>
                <DialogTitle>
                  ...
                  {selectedType === "clinicVisits" && "🏥 진료 기록 관리"}
